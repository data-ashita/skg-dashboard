...
with tab2:
    ...
    if df_curr.empty:
        ...
        dd_channel = st.pills(
            ...
            options=chan_opts,
            default=chan_opts[0] if chan_opts else None,
            selection_mode="single",
            key="deepdive_channel"
        )
        ...
        if selected_type and 'event_name' in locals() and event_name and event_name.selection.rows:
            ...
            if 'name_summary' in locals() and selected_index_name < len(name_summary):
